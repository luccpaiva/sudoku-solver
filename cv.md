Carefully analyse these resume guidelines:
"ntroduction
What is a resume?
...
Debunking Myths: The Truth About Applicant Tracking Systems
Recommended Templates
/r/EngineeringResumes/wiki/templates

Google Docs https://imgur.com/TraV3Qn
LaTeX https://imgur.com/LC6AS8r
Accessibility
...
Don't mask your email address, GitHub profile, and portfolio website i.e. email, github, portfolio
...
Now analyse my CV and suggest improvements to better align with the good practices. Ask me questions if you need more information:
Lucas Paiva | PhD Engineer & Developer
Portugal (available to relocate) | +351 936 745 964 | lucaspaiva96@gmail.com | www.lucaspaiva.com
Professional Profile
Full-stack developer with a PhD in Numerical Modeling and 3+ years building production software. Proven track record translating complex engineering problems into automated solutions. Strong foundation in scientific Python (NumPy, SciPy, Pandas), numerical methods, algorithm design, and RESTful microservices. Founded Proautom8, architecting data pipelines for fiber-to-the-home projects.
Work Experience
Proautom8 – Automation Company
Founder and Lead Developer Jan 2024 – Present
• Architected an automated system for generating splice maps for FTTH projects
• Reduced project completion time from months/weeks to minutes
• Developed a data extraction and data treatment pipeline to process geospatial data using QGIS
• Built a webapp and VM in Azure/Flask to generate project files (experience with REST)
• Generated €27k in 2025 (expected total revenue of €100k over the next two years)

Lima Toitures – Precast Timber Industry
Engineer Jan 2021 – Dec 2025
• Part of the team developing an in-house software to design nail-plate trusses
• Implemented algorithms for structural design of timber connections
• Built automated reporting to generate engineering documentation for standard compliance
• Experience on the interface of Engineering/Programming

Skills
Programming Languages: Python, JavaScript/Typescript, HTML/CSS, VBA, Lua
Tools & Frameworks: Git, REST, Pandas, NumPy, SciPy, XlWings, Flask, Django, QGIS, React, Azure

Education
University of Aveiro – PhD in Numerical Modeling 2021 – 2025
...
• Published research combining computational modelling and experimental data analysis

Projects
FTTH Splice Map Automation System Jan 2024 – Present
• Implemented several breadth-first search algorithms for complex multi-layer network routing
• Integrated QGIS to extract and process geospatial data of DXF files
• Automated generation of splice maps combining Python Libraries(Xlwings, Openpyxl) with VBA

Human-like Sudoku Solver 2024
• interactive Sudoku solver using constraint satisfaction algorithms, replicating human strategies
• Modular architecture using OOP, dictionaries and sets to efficient board representation

LP

I'll analyze your CV and suggest improvements based on the provided guidelines.

Initial Observations

Your CV is well-structured, and you've included relevant sections such as Work Experience, Skills, Education, and Projects. However, there are some areas that can be improved to better align with the guidelines.

Contact Information

You've included your location (Portugal), which might cause implicit bias. Consider removing it unless the specific job you're applying for is in Portugal.
Your phone number is unnecessary; recruiters will email you for your phone number if needed.
You've used a modern email provider (Gmail), which is good.
Your personal website (www.lucaspaiva.com) is included, but make sure it's up-to-date and relevant.
Professional Profile

You've included a summary/profile, which is generally discouraged unless you're a senior/staff engineer or above. Consider removing it or rephrasing it to be more concise (<2 sentences).
Work Experience

You've used a clear and concise format for your work experience.
You've highlighted your achievements and technical work, which is good.
However, some bullet points could be more specific and quantifiable (e.g., "Reduced project completion time from months/weeks to minutes" is good, but consider adding more context or metrics).
Skills

You've listed your skills in a clear and concise manner.
You've separated your skills into relevant categories (Programming Languages, Tools & Frameworks), which is good.
Consider reordering your skills to prioritize the most important ones.
Education

You've included your PhD education, which is relevant.
You've mentioned your research experience and skills used during your PhD, which is good.
Projects

You've included relevant projects that demonstrate your technical skills.
You've used a clear and concise format for your project descriptions.
Consider adding more context or metrics to your project descriptions.
Other Observations

You've used a modern font and formatting, which is good.
You've avoided excessive italicization, bolding, and ALL CAPS, which is good.
To better understand your CV and provide more specific suggestions, I have a few questions:

Are you applying for a specific job or industry?
Can you provide more context about your work experience and projects (e.g., specific challenges you faced and overcame)?
I'll provide more detailed suggestions once I have a better understanding of your CV and the context.